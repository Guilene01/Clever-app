...
# DB-backed sessions scale across processes and don't leave files on disk
...
SUMMARIZER_URL = os.environ.get("SUMMARIZER_URL", "")
...
# Production-only hardening — kept off in dev so runserver works without TLS
if not DEBUG:
